...
<body>
    ...
    <div class="imagenes">
        <div class="imagen1">
            <a href="#hoteles"><img src="imagenes/hotel.jpg" alt="Hoteles"></a>
            <div class="texto_imagen">HOTELES</div>
        </div>
        <div class="imagen2">
            <a href="#cabañas"><img src="imagenes/cabañas.jpg" alt="Cabañas"></a>
    ...
    <section class="hoteles">
        <div class="titulo_hoteles" id="hoteles">
            <h2>Hoteles</h2>
            <p>Disfruta de nuestros hoteles</p>
        </div>
        <div class="varios_hoteles">
            <div class="hotel1">
                <h3>Hotel Melbourne</h3>
                <br>
                <a href="#Melbourne"><img src="https://www.construcia.com/wp-content/uploads/2023/10/Construcia-Hyde-158-700x467.jpg" alt="" width="380" height="300"></a>
            </div>
            <div class="hotel1">
                <h3>Hotel Calderon Cortes</h3>
                <br>
                <a href="#Calderon"><img src="https://cdn.forbes.co/2020/02/sofitel-legend-santa-clara-outdoor-pool.jpg" alt="" width="380" height="300"></a>
            </div>
            <div class="hotel1">
                <h3>Hotel Reyes</h3>
                <br>
                <a href="#Reyes"><img src="https://www.realhotelsandresorts.com/wp-content/uploads/2024/08/fachada-principal-700x467.jpg" alt="" width="380" height="300"></a>
            </div>
        </div>
    ...
    <section class="cabañas" id="cabañas">
        <div class="titulo_cabañas">
            <h2>Cabañas</h2>
            <p>Disfruta de nuestras cabañas</p>
        </div>
        <div class="varios_cabañas">
            <div class="cabaña1">
                <h3>Cabaña 1</h3>
                <br>
                <a href="#Cabaña1"><img src="https://www.cabanasdelvalle.com/wp-content/uploads/2020/10/cabana-1.jpg" alt="" width="380" height="300"></a>
            </div>
            <div class="cabaña1">
                <h3>Cabaña 2</h3>
                <br>
                <a href="#Cabaña2"><img src="https://www.cabanasdelvalle.com/wp-content/uploads/2020/10/cabana-2.jpg" alt="" width="380" height="300"></a>
            </div>
        </div>
    </section>
    <footer>
